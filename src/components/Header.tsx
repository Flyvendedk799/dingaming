          ...
          <div className="flex items-center justify-between h-16 lg:h-18">
            ...
            <div className="flex items-center gap-2">
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <Button variant="outline" className="relative gap-2 border-primary/30 hover:border-primary hover:bg-primary/5 group">
                  <motion.div
                  ...
                  <AnimatePresence>
                    {cartCount > 0 && (
                      <motion.span 
                        className="absolute -top-2 -right-2 w-5 h-5 bg-primary text-primary-foreground text-xs rounded-full flex items-center justify-center font-semibold shadow-sm"
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        exit={{ scale: 0 }}

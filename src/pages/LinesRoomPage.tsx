...
import LinesGame from "@/components/games/LinesGame";
          ...
          <div className="container mx-auto px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="font-heading text-xl text-white">Lines</h1>
              </div>
            </div>
          ...
          >
            ...
            >
              <p className="text-white/50 text-sm">
                Vælg op til 5 linjer og spin. Match 3 symboler på en linje for at vinde!
              </p>
            </motion.div>

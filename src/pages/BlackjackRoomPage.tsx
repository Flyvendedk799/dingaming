...
const BlackjackRoomPage = () => {
  ...
  return (
    <div className="min-h-screen relative">
      <CasinoBackground variant="blackjack" />
          ...
          <div className="container mx-auto px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="font-heading text-xl text-white">Blackjack</h1>
              </div>
            </div>
          ...
          >
            ...
            >
              <p className="text-white/50 text-sm">
                Slå dealeren ved at komme tættest på 21 uden at gå over. Blackjack betaler 3:2.
              </p>
            </motion.div>
...
export default BlackjackRoomPage;

...
const MinesRoomPage = () => {
  ...
  return (
    <div className="min-h-screen relative">
      <CasinoBackground variant="mines" />
          ...
          <div className="container mx-auto px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="font-heading text-xl text-white">Mines</h1>
              </div>
            </div>
          ...
          >
            ...
            >
              <p className="text-white/50 text-sm">
                Undgå minerne og afsløre så mange felter som muligt. Jo flere felter du afslører, jo højere bliver din multiplier.
              </p>
            </motion.div>
